...
int main(int argc, char** argv)
{
	...
	ustawienia.sin_addr.s_addr = inet_addr( strHost.c_str() );	// Adres IP serwera to TEN komputer, potem prze³¹czymy jak nawi¹¿emy komunikacjê
	...
	{
		cout << "Nie mo¿na zabindowaæ gniazda" << endl;    
	...
	// Próba nas³uchiwania na danym porcie
	...
	// Utworzenie gniazda pomocniczego do prze³¹czenia, jeœli zostanie wychwycona komunikacja
